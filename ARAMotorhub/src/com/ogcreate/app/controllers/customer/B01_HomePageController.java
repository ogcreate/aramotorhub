...
public class B01_HomePageController implements Initializable {
    ...
    void handleImageClick(MouseEvent event) {
        ...
        try {
            FXMLLoader loader = new FXMLLoader(getClass().getResource("/resources/fxml/customer/B02_HomePage.fxml"));
